...
Requires:      openstack-nova-compute >= 14.0.0
Requires:      python-nova >= 14.0.0
...
%changelog
* Mon Jan 16 2017 Vincent Llorens <vincent.llorens@cc.in2p3.fr> - 14.0.0~indigo-1
- Update OpenStack dependency to Newton
